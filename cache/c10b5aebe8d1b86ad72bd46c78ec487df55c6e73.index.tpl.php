...
<body>
  <div id="wrap">
    ...
    <div id="content">
      ...
      <!-- 投稿記事を取得する -->
              <div class="msg">
          <img src="member_picture/20210409064310男１.png" width="48" height="48" alt="本田" />
          <p>
          ...
          <p class="day">
            ...
            <!-- 返信投稿のみ表示 -->
              ...
              <div class="msg">
          <img src="member_picture/20210409064230Alex.jpg" width="48" height="48" alt="Alex" />
          <p>
          ...
          <p class="day">
            ...
            <!-- 返信投稿のみ表示 -->
              ...
              <div class="msg">
          <img src="member_picture/20210404065616女２.png" width="48" height="48" alt="koji" />
          <p>
